...
## Extracting TS differce between Sender and Rxer based on Sequence Number
def computeDelaybnWiresharkSenderNRxer(inFile1, inFile2, inFile3, outFile1):
...
computeDelaybnWiresharkSenderNRxer(inFile1, inFile2, inFile3, outFile1)
